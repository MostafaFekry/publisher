	...
	class ProductListing {
		...
		bind_filters() {
			...
			$('.product-filter').on('change', frappe.utils.debounce((e) => {
				...
				window.history.pushState('filters', '', '/all-books?' + query_string);
				window.location.href = frappe.utils.get_url_from_dict();
		...
		get_items_with_filters() {
			...
			return new Promise((resolve, reject) => {
				frappe.call('publisher.publisher.product_configurator.utils.get_products_html_for_website', args)
					.then(r => {
