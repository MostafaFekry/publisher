...
def add_comment(comment, comment_email, comment_by, reference_doctype, reference_name, route, publication_rating=None):
	...
	comment.db_set('publication_rating', publication_rating or 0)
